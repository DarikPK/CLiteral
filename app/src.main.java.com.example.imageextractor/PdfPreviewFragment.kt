...
class PdfPreviewFragment : Fragment() {
    ...
    private var stampWearSize: Float = 0f // Added for wear size effect
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            ...
            if (isStampEnabled) {
                ...
                stampWearSize = it.getFloat("stampWearSize", 50f) // Retrieve wear size
    ...
    fun applyInkWear(source: Bitmap, intensity: Float, size: Float, seed: Long): Bitmap {
        ...
        // Convert size (0-1) and intensity (0-1) to multipliers, and triple the effect
        val sizeMultiplier = (1 + size * 2) * 3f
        val intensityMultiplier = (1 + intensity * 2) * 3f
        ...
        // Combine the source bitmap with the generated mask
