...
class VoucherConfigFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnGenerateVoucher.setOnClickListener {
            ...
            b.putString("ruc", binding.etRuc.text.toString())
            b.putString("local", binding.etLocal.text.toString())
            b.putString("recibo", binding.etRecibo.text.toString())
            b.putString("fecha", binding.etFecha.text.toString())
            b.putString("cajero", binding.etCajero.text.toString())
            b.putString("partida", binding.etPartida.text.toString())
            b.putString("paginas", binding.etPaginas.text.toString())
            b.putString("monto", binding.etMonto.text.toString())
            b.putString("presentante", binding.etPresentante.text.toString())
