...
class PdfSettingsFragment : Fragment() {
    ...
    private fun navigateToPreview(folder: ImageFolder) {
        ...
        val bundle = Bundle().apply {
            ...
            bundle.putFloat("stamp2_dot_count", sharedPreferences.getFloat("stamp2_dot_count", 3f))
            bundle.putFloat("stamp2_dot_size", sharedPreferences.getFloat("stamp2_dot_size", 13f))
            }
